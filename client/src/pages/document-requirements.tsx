  ...
  return (
    <div className="min-h-screen bg-gray-50" dir="rtl">
      ...
      <div className="flex">
        ...
        <main className="flex-1 mr-0 md:mr-72 p-6 pt-20">
                                ...
                                >
                                  ...
                                  <SelectContent>
                                    ...
                                    {Array.isArray(variablesData) && variablesData
                                      .filter((v: any) => ['form', 'manual', 'missing', 'rasmio'].includes(v.source))
                                      .map((variable: any) => (
                                        <SelectItem key={variable.id} value={variable.name}>
                                          {variable.label} ({variable.name}) - {variable.source === 'rasmio' ? 'رسمیو' : 'فرم/دستی'}
                                        </SelectItem>
                                      ))}
