...
export default function AdminEmployeeBaleSettings() {
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      const response = await fetch('/api/admin/employee-bale-settings');
  ...
  const handleDelete = async (employeeId: number) => {
    try {
      const response = await fetch(`/api/admin/employee-bale-settings/${employeeId}`, {
        method: 'DELETE'
      });
  ...
  const handleToggleStatus = async (employeeId: number) => {
    try {
      const response = await fetch(`/api/admin/employee-bale-settings/${employeeId}/toggle-status`, {
        method: 'POST'
      });
  ...
  const handleToggleNotifications = async (employeeId: number) => {
    try {
      const response = await fetch(`/api/admin/employee-bale-settings/${employeeId}/toggle-notifications`, {
        method: 'POST'
      });
