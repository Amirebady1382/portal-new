...
const sidebarItems: SidebarItem[] = [
  ...
  {
    id: "investment-financial-summary",
    label: "گزارش وضعیت اعتباری",
    icon: BarChart3,
    path: "/financial-summary", // Corrected path
    roles: ["employee", "admin", "ceo"],
  },
  {
    id: "company-status",
    label: "وضعیت شرکت",
...
const sidebarSections = [
  ...
  {
    title: "گزارش‌گیری",
    items: ["reports", "ai-analysis", "investment-report-generator", "investment-financial-summary", "company-status"],
  },
  {
    title: "مدیریت سیستم",
