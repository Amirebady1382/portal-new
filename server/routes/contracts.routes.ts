...
contractsRoutes.delete("/templates/:id", authMiddleware, requireRole(["admin", "employee"]) as any, (req, res) => contractsController.deleteContractTemplate(req as any, res));
...
contractsRoutes.get("/templates/:id/download", authMiddleware, requireRole(["admin", "employee"]) as any, (req, res) => contractsController.downloadTemplate(req as any, res));
