...
import { documentRequirementsRoutes, formSubmissionsRoutes } from "./routes/document-requirements.routes";
import { documentsRoutes, companyDocumentsRoutes } from "./routes/documents.routes";
...
import { servicesRoutes, companyServicesRoutes, serviceRequestsRoutes } from "./routes/services.routes";
...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.use("/api/companies", aiChatRoutes);
  ...
  app.use("/api/companies", companyDocumentsRoutes); // Added this
  app.use("/api/companies", companyServicesRoutes); // Added this
  app.use("/api", contractVariablesRoutes);
