...
export class TemplateValidationService {
  ...
  /**
   * Get full extraction details for variables in a template
   */
  async getExtractionDetails(templatePath: string) {
    return await unifiedVariableManager.extractVariables(templatePath, {
      useCache: true,
      fixBrokenVariables: true,
      detectSource: true
    });
