...
async function runTests() {
  ...
  console.log('── SETUP ──');
  dbq("INSERT INTO companies(name,national_id,registration_number,type,status) VALUES('E2E Co','E2ETEST99','E2EREG','private','active') ON CONFLICT(national_id) DO NOTHING;");
  ...
  dbq(`INSERT INTO user_companies(user_id,company_id,is_owner,created_at) VALUES(4,${CO_ID},false,NOW()) ON CONFLICT DO NOTHING;`);
